...
val _ = new_theory "parallelcompositiongeneraldeduction";
...
Define `
       (combineAllDed (ded1:('pred1) tded) (ded2:('pred2) tded) (ded3:('pred1 + 'pred2) tded) (P3:('pred1 + 'pred2) set) (F3:('pred1 + 'pred2)) = (
