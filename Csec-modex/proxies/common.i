# 1 "/home/faezeh/csec-modex/proxies/common.c"
...
# 7 "/home/faezeh/csec-modex/proxies/common.c" 2
...
# 9 "/home/faezeh/csec-modex/proxies/common.c" 2
              ...
              const char * name)
{
  ...
  Len();
  BS(
# 26 "/home/faezeh/csec-modex/proxies/common.c" 3 4
    0
# 26 "/home/faezeh/csec-modex/proxies/common.c"
         , lenlen);
  Done();
...
void readenvE(const unsigned char * buf, const unsigned char * len, size_t lenlen, const char * name)
{
  ...
  Len();
  BS(
# 56 "/home/faezeh/csec-modex/proxies/common.c" 3 4
    0
# 56 "/home/faezeh/csec-modex/proxies/common.c"
         , lenlen);
  Done();
  ...
  if(len != 
# 61 "/home/faezeh/csec-modex/proxies/common.c" 3 4
           ((void *)0)
# 61 "/home/faezeh/csec-modex/proxies/common.c"
               )
    StoreBuf(len);
  else
    Clear(1);
...
void readenvL(const unsigned char * buf, size_t len, const char * name)
{
  ...
  assume_intype("bitstring");
  assume_len(&len, 
# 79 "/home/faezeh/csec-modex/proxies/common.c" 3 4
                  0
# 79 "/home/faezeh/csec-modex/proxies/common.c"
                       , sizeof(len));
...
void make_sym(const unsigned char * buf, size_t len, const char * s)
{
  SymN(s, 0);
  assume_len(&len, 
# 87 "/home/faezeh/csec-modex/proxies/common.c" 3 4
                  0
# 87 "/home/faezeh/csec-modex/proxies/common.c"
                       , sizeof(len));
  Hint(s);
  Nondet();
  store_buf(buf);
...
void append_zero(const unsigned char * buf)
{
  load_all(buf, "");
  load_int(0, 
# 150 "/home/faezeh/csec-modex/proxies/common.c" 3 4
             1
# 150 "/home/faezeh/csec-modex/proxies/common.c"
                 , sizeof(char), "");
